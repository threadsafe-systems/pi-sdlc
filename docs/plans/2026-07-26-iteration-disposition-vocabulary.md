...
| 11 | `.pi/sdlc/CONFIG.md` | Regenerate (was stale vs `sdlc.config.json`) as its own `chore` commit on this branch. **Executed at `7c2ae92`; `config-doc check` reports `current`.** Gated by spec scenario IDV24. |
