...
- runner: PASS — exit 0
- report: `docs/reviews/task-validate-spec-artifact-skeleton-t1-2026-08-08/report.json`
...
```acceptance-report
{
  ...
  "commandsRun": [
    {
      "command": "skills/sdlc/scripts/validate-task.sh --manifest docs/validation/spec-artifact-skeleton/t1.json --repo-root . --format json --report docs/reviews/task-validate-spec-artifact-skeleton-t1-2026-08-08/report.json",
      "result": "passed",
